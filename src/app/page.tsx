...
export default function Home() {
  return (
    <section className="container h-[650px] md:h-[82vh]  flex justify-between flex-col">
      <div>
        <div className="border-t border-e border-black ">
          ...
          >
            <h1
              className="text-[2.6rem] md:text-[4.5rem] pl-5 md:pl-0 font-[600] max-w-xs md:max-w-xl 
